...
class FunctionsFinalTestScreen extends StatefulWidget {
  final Set<String> practiceQuestionIds;

  const FunctionsFinalTestScreen({
    super.key,
    required this.practiceQuestionIds,
  });

  @override
  State<FunctionsFinalTestScreen> createState() =>
      _FunctionsFinalTestScreenState();
}

class _FunctionsFinalTestScreenState extends State<FunctionsFinalTestScreen> {
  ...
  void initState() {
    ...
    final unseen = mockFunctionsExercises
        .where((exercise) => !widget.practiceQuestionIds.contains(exercise.id))
        .toList()
      ..shuffle();

    final fallback = mockFunctionsExercises
        .where((exercise) => widget.practiceQuestionIds.contains(exercise.id))
        .toList()
      ..shuffle();
      ...
      Navigator.of(context).pushReplacement(
        MaterialPageRoute(
          builder: (_) => ResultScreen(
            completedLessonId: AppProgress.functionsId,
