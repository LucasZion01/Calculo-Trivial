...
class ContinuityFinalTestScreen extends StatefulWidget {
  final Set<String> practiceQuestionIds;

  const ContinuityFinalTestScreen({
    super.key,
    required this.practiceQuestionIds,
  });

  @override
  State<ContinuityFinalTestScreen> createState() =>
      _ContinuityFinalTestScreenState();
}

class _ContinuityFinalTestScreenState extends State<ContinuityFinalTestScreen> {
  ...
  void initState() {
    ...
    final unseen = mockContinuityExercises
        .where((exercise) => !widget.practiceQuestionIds.contains(exercise.id))
        .toList()
      ..shuffle();

    final fallback = mockContinuityExercises
        .where((exercise) => widget.practiceQuestionIds.contains(exercise.id))
        .toList()
      ..shuffle();
      ...
      Navigator.of(context).pushReplacement(
        MaterialPageRoute(
          builder: (_) => ResultScreen(
            completedLessonId: AppProgress.continuityId,
